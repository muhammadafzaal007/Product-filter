...
let mappedData = myData.products.map((meraData)=>`
<div class="product">
          <img src="${meraData.images[0]} " alt="" />
          <div class="product-header">
            <h4>${meraData.category} </h4>
            <button>${meraData.price}</button>
          </div>
          <h4>${meraData.title} </h4>
          <p>${meraData.description}</p>
        </div>
`).join(' ')
menu.innerHTML = mappedData
}
allProducts()
function beautyProducts() {
    let filteredData = myData.products.filter((meraData)=> meraData.category === 'beauty')
    let mappedData = filteredData.map((meraData)=>`
<div class="product">
          <img src="${meraData.images[0]} " alt="" />
          <div class="product-header">
            <h4>${meraData.category} </h4>
...
function groceriesProducts() {
    let filteredData = myData.products.filter((meraData)=> meraData.category === 'groceries')
    let mappedData = filteredData.map((meraData)=>`
<div class="product">
          <img src="${meraData.images[0]} " alt="" />
          <div class="product-header">
...
function furnitureProducts() {
    let filteredData = myData.products.filter((meraData)=> meraData.category === 'furniture')
    let mappedData = filteredData.map((meraData)=>`
<div class="product">
          <img src="${meraData.images[0]} " alt="" />
          <div class="product-header">
...
function fragrancesProducts() {
    let filteredData = myData.products.filter((meraData)=> meraData.category === 'fragrances')
    let mappedData = filteredData.map((meraData)=>`
<div class="product">
          <img src="${meraData.images[0]} " alt="" />
          <div class="product-header">
